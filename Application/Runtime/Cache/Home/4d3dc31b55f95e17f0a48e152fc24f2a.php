    ...
    <div class="login" style="width: 660px;">
        ...
        <div class="body form " style="margin-top: -30px;">
            ...
            <div style="width: 230px; float: left;">
                <img src="http://localhost:9990/gtp/<?php get_imgPath($group['face'], 'm'); ?>" style="width:200px; height: 200px;" class="jcrop-preview" id="target" alt="Preview" />
            </div>
            ...
            <div id="preview-pane" style="margin-top: 15px; float: left;">
                <div class="preview-container" >
                    <img src="http://localhost:9990/gtp/<?php get_imgPath($group['face'], 'm'); ?>" class="jcrop-preview" alt="Preview" />
                </div>
            </div>
