...
<div class="ident">话题</div>
    <div class="login">
        ...
        <div class="body form ">
            <form action="http://localhost:9990/gtp/topic/edit" method="post" class="login">
                <table>
                    <tr>
                        <th>标题</th>
                        <td>
                            <input class="text" type="text" name="title" value="<?php echo ($topic["title"]); ?>" style="width: 417px;" />
                        </td>
                    </tr>
                    ...
                    <tr>
                        <th>内容</th>
                        <td>
                            <textarea name="content" class="textarea" rows="10" cols="50"><?php echo (br2nl($topic["content"])); ?></textarea>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <th>&nbsp;</th>
                        <td>
                            <input type="hidden" name="group_id" value="<?php echo ($topic["group_id"]); ?>" />
                            <input type="hidden" name="topic_id" value="<?php echo ($topic["id"]); ?>" />
                            <input class="submit" type="submit" value="编辑" /> &nbsp;
                            <a href="http://localhost:9990/gtp/topic/<?php echo ($topic["id"]); ?>">回到话题</a>
                        </td>
                    </tr>
                </table>
            </form>
