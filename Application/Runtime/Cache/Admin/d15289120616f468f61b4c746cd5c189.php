...
<div class="am-cf admin-main">
  ...
  <div class="admin-content">
    ...
    <div class="am-cf am-padding">
      <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">吉他谱管理</strong> / <small>Table</small></div>
    </div>
    ...
    <div class="am-g">
      <div class="am-u-sm-12">
        <form class="am-form">
          ...
          <tbody>
            <?php if(is_array($items)): foreach($items as $key=>$item): ?><tr>
              <td><input type="checkbox" /></td>
              <td><?php echo ($item["id"]); ?></td>
              <td><a href="http://localhost:9990/gtp/gtp/<?php echo ($item["id"]); ?>" target="_blank"><?php echo ($item["song_title"]); ?></a></td>
              <td><?php echo ($item["artist_name"]); ?></td>
              <td class="am-hide-sm-only"><?php echo ($item["nick"]); ?></td>
