...
<div class="admin-content">
  ...
  <div class="am-cf am-padding">
    <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">添加Blog</strong> / <small>form</small></div>
  </div>
  ...
  <div class="am-tabs am-margin" data-am-tabs>
    ...
    <form action="http://localhost:9990/gtp/admin/blog/add" method="post" enctype="multipart/form-data" class="am-form">
    <div class="am-tabs-bd">
          ...
          <div class="am-tab-panel am-fade" id="tab2">
              ...
              <div class="am-g am-margin-top">
                ...
                <div class="am-u-sm-8 am-u-md-4">
                  <input type="text" name="description" class="am-input-sm">
                </div>
              ...
              <div class="am-g am-margin-top">
                ...
                <div class="am-u-sm-8 am-u-md-4 am-u-end col-end">
                  <input type="text" name="tags" class="am-input-sm">
                </div>
              </div>
